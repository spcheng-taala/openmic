...
const what2 = "You must be at least 13 to use OpenMic. Further, you may not access or use the Services if your access or use of the Services is prohibited or conflicts with any applicable local, state, national or international laws and regulations. You must notify us immediately of any change in your eligibility to use the Services. We may, in our sole discretion, refuse to offer the Services to any person or entity and change these eligibility criteria at any time.";
...
"Account. We will not be liable for any loss or damage arising from your failure to comply with this Section." + "You will have the ability to delete your Account, either by following the instructions on the Services or by sending a request to help@openmic.fm.";
const what3 = "When creating an account on OpenMic, you should be considerate to other people who may hear or see your podcast. You're not allowed to impersonate anyone with the intent to deceive, or use branding that is offensive or inappropriate."
...
const what4_2 = "You're not allowed to use OpenMic to infringe on copyrighted content, break any laws, or cause harm to other people. If you do, you'll be held personally and solely responsible.";
...
const what4_4 = "Content on OpenMic can be consumed, distributed, and shared by other OpenMic users. However, users cannot sell each other's content without the content owner's permission.";
const title4_5 = "License Grant";
const text4_5 = "You retain all of your ownership rights in your User Content. Using OpenMic never has and never will cause you to lose ownership of your content.";
const what4_5 = "You own your content. By using OpenMic, you are not giving up any rights to use your content in any way or any place you want. OpenMic prides itself on empowering creators, and we have no intention to limit your rights in your content in any way."
const text4_6 = "By submitting User Content through the Services, you hereby grant us a non-exclusive license to use, edit, modify, aggregate, reproduce, distribute, display, and perform the User Content in connection with the operation of the Services, the promotion, advertising or marketing of the Services, and the operation of OpenMic’s (and its successors’ and affiliates’) business. This license is worldwide, royalty-free, sublicensable and transferable.";
const what4_6 = "In order to use OpenMic, you are giving us permission to use, host, and distribute the content you create. For instance, this license allow us to syndicate your content to other platforms, so that your audience can hear your podcast anywhere they choose. We believe strongly in creators’ rights, and in no way does this license take away the ownership rights you have in your content.";
const text4_7 = "You agree that this license includes, without limitation, the right for OpenMic to provide, promote, and improve the Services. We may also use this license to make User Content available to other companies, organizations or individuals who partner with OpenMic for the syndication, broadcast, distribution or publication of such User Content on other media and services.";
const what4_7 = "One of the best parts of OpenMic is the ability to create in one place and optionally let us handle the hassle of distributing your podcast everywhere. This language allows us to distribute your content on your behalf, so that you can focus on creating and leave the technical headache of podcast distribution to us. You are also welcome to distribute your podcast to other platforms manually if you prefer.";
const text4_8 = "Such license will terminate within a commercially reasonable time upon the termination of your account on OpenMic as it applies to User Content stored in the Services or otherwise controlled by OpenMic at the time of termination.";
const what4_8 = "If you leave OpenMic (which you are free to do at any time) and ask us to delete your content, we will do so promptly. Note that content that is distributed to third parties may be out of our control. In those cases, you may have to reach out to other companies (such as audio playing apps) to ask them to remove your content directly.";
...
const what4_10 = "YOU own your own content. However, you also promise us that your content is actually yours, and that by putting it on OpenMic, you're not violating anyone else's rights.";
...
const what5_5 = "Please don't intentionally overload our servers, attempt to bypass our security measures, or generally do anything intentionally malicious on OpenMic.";
...
const text6 = "The OpenMic name and logos are trademarks and service or brand identifier’s marks of OpenMic (collectively the “OpenMic Trademarks”). Other company, product, and service names and logos used and displayed via the Services may be trademarks or service marks of their respective owners who may or may not endorse or be affiliated with or connected to us.";
const what6 = "You agree not to use OpenMic's brand, including our logo, for any purpose without our permission. Doing so may be an infringement of our intellectual property.";
const text6_2 = "Nothing in this Terms of Service or the Services should be construed as granting, by implication, estoppel, or otherwise, any license or right to use any of OpenMic Trademarks displayed on the Services, without our prior written permission in each instance. All goodwill generated from the use of OpenMic Trademarks will inure to our exclusive benefit.";
...
const what7 = "We do not review or monitor external links put in OpenMic content. Please be careful when clicking any link to the outside world, and please be mindful of which links you add to your own content.";
...
const what8 = "Because you have an OpenMic account, we can contact you via text if necessary.";
const text8_2 = "OpenMic does not charge a fee to use the Services, but any text messages sent and/or received using the Services are subject to standard text messaging rates. Additionally, text messages sent and/or received count towards a monthly quota as any other messages do. You acknowledge that, whether you are sending or receiving text messages using the Services, standard text messaging rates may apply. In the event you change or deactivate your mobile telephone number, you agree to promptly update your Company account information to ensure that your messages are not sent to the person that acquires your old number.";

const text9 = "If you are accessing the Services via an OpenMic mobile application (an “Application”) on a device provided by Apple, Inc. ('Apple') or an Application obtained through the Apple App Store, the following will apply:";
const text9_2 = "Both you and OpenMic acknowledge that these Terms of Service are concluded between you and OpenMic only, and not with Apple, and that Apple is not responsible for the Application or the Content;";
...
const what10 = "If you choose to link your other social accounts to OpenMic through some of our features, you recognize that some data about you is shared between us and these third parties. Always be careful about what personal information you share on any platform, including OpenMic. Your privacy is of paramount importance to us, and we will always strive to respect that privacy.";
const text10_2 = "For more information about the implications of activating these Social Networking Services and our use, storage and disclosure of information related to you and your use of such services within OpenMic (including your friend lists and the like), please see our Privacy Policy. However, please remember that the manner in which Social Networking Services use, store and disclose your information is governed solely by the policies of such third parties, and we will have no liability or responsibility for the privacy practices or other actions of any third party site or service that may be enabled on the Services.";
...
const what11 = "Common sense and generally being a nice person means you can use OpenMic all you wish! But if we do ever find reason to terminate your account, we have the ability to do so without a guarantee that we will notify you.";
...
const text11_3 = "If you wish to terminate your Account, you may do so by contacting us at help@OpenMic.fm.";
...
const what15 = "If you and OpenMic ever have a disagreement (and we hope that never happens!), instead of facing the lengthy and expensive process of going to court, we agree to use the alternative dispute resolution process described here.";
...
const what17_3 = "This agreement is between you and OpenMic (or potentially between you and whoever might own OpenMic in the future if we ever become acquired by another company down the line).";
...
const what17_4 = "This agreement between you and OpenMic is not an employment or contracting agreement. It simply governs your usage of our platform.";
const title17_5 = "Notices";
const text17_5 = "Unless otherwise specified in these Term of Service, all notices under these Terms of Service will be in writing and will be deemed to have been duly given when received, if personally delivered or sent by certified or registered mail, return receipt requested; when receipt is electronically confirmed, if transmitted by facsimile or e-mail; or the day after it is sent, if sent for next day delivery by recognized overnight delivery service. Electronic notices should be sent to help@openmic.fm.";
const what17_5 = "Email us at help@openmic.fm if you need to contact us. Most of our contact with you will also be through email.";
...
const what17_6 = "If you and OpenMic ever agree to some kind of exception to these terms, it must be agreed to in writing.";
  ...
  render() {
    const { classes } = this.props;
      ...
      <div style={root}>
        ...
        <p style={textStyle}>{"The products and services are provided by Pokadot, Inc. (“OpenMic”, “us”, “we” or “our”). Please carefully read these Terms of Service, our Privacy Policy and our DMCA Copyright Policy (collectively, the “Terms of Service”). The Terms of Service govern your access to and use of OpenMic’s services, including OpenMic’s websites, SMS, APIs, email notifications, applications, buttons, widgets, ads and other services (collectively, the “Services”)."}</p>
