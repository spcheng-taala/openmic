...
"Account. We will not be liable for any loss or damage arising from your failure to comply with this Section." + "You will have the ability to delete your Account, either by following the instructions on the Services or by sending a request to help@theopenmic.fm.";
...
const text11_3 = "If you wish to terminate your Account, you may do so by contacting us at help@theopenmic.fm.";
...
const text17_5 = "Unless otherwise specified in these Term of Service, all notices under these Terms of Service will be in writing and will be deemed to have been duly given when received, if personally delivered or sent by certified or registered mail, return receipt requested; when receipt is electronically confirmed, if transmitted by facsimile or e-mail; or the day after it is sent, if sent for next day delivery by recognized overnight delivery service. Electronic notices should be sent to help@theopenmic.fm.";
const what17_5 = "Email us at help@theopenmic.fm if you need to contact us. Most of our contact with you will also be through email.";
